...
/**
 * @param {object} bundle
 * @param {{ forNpcChat?: boolean }} [opts]
 *   forNpcChat: reframe ST persona/card as background only — NPC must not become the player.
 */
export function formatContextForPrompt(bundle, opts = {}) {
